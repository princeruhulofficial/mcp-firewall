...
mcp-firewall is evolving into a **Zero Trust AI Execution Layer**: a default runtime control layer that sits between AI agents, MCP servers, tools, APIs, files, databases, and production systems.
